...
const styles = {
  ...
  title: { fontFamily: 'GoogleSansFlex-Bold', color: '#FFFFFF', fontSize: 20, textAlign: 'center' as const, marginBottom: 12 },
  ...
  buttonText: { fontFamily: 'GoogleSansFlex-Title', color: '#1E1A1E', fontSize: 16 },
};
