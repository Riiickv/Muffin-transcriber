...
export const DE = {
  tester: {
    welcomeTitle: "Du bist ein Tester!",
    welcomeBody: "Muffin ist noch in Entwicklung und du bist ein Tester! Wenn es dir nützt, sag mir gern, was du denkst, vor allem, was du ändern, ergänzen oder reparieren würdest. Danke!",
    welcomeOk: "Alles klar",
  },
  ...
  transcribe: {
    ...
    supportDesc: "Muffin ist kostenlos, privat und läuft offline. Wenn es dir gefällt und du mein Projekt unterstützen willst, hier ist wie!",
    supportCancel: "Vielleicht später",
  },

  coach: {
    micHint: "Tippen zum Aufnehmen/Stoppen, halten für Optionen!",
  },

  record: {
    silentTitle: "Muffin hört nichts",
    silentBody: "Diese Aufnahme ist bisher still. Prüfe, ob das richtige Mikrofon ausgewählt ist und keine andere App es benutzt. Die Aufnahme läuft weiter.",
    optionsTitle: "Aufnahmeoptionen",
  ...
  historyDetail: {
    ...
    summaryFailed: "Konnte das nicht zusammenfassen.",
    busyTitle: "Eins nach dem anderen!",
    busyMessage: "{next} zu starten stoppt {current}.",
  ...
  chat: {
    betaEnableBody: "Der Chat mit Muffin ist noch nicht fertig. Du kannst ihn testen und mir Feedback schicken, das würde die Entwicklung enorm beschleunigen.\n\nWas gerade funktioniert:\n• Er kann die Einstellungen der App für dich ändern und dir zeigen, wo sie sind.\n• Er kennt die ganze App, also hilft er dir, alles zu finden.\n• Manchmal findet er die Transkription, die du suchst, wenn du ihm das Thema nennst.\n\nWas nicht:\n• Du kannst nicht zuverlässig mit ihm chatten, also kann er dir nicht wirklich beim Nachdenken über deine Transkripte helfen. Das ist eine Grenze mobiler Geräte, und ich suche nach allen Wegen, die Last auf mittleren und schwächeren Handys zu senken.\n\nEs ist noch viel mehr geplant, aber das braucht Zeit und Tests.\n\nDanke für deine Geduld!\n\n-Rick",
    header: "Chat",
    beta: "Beta",
    betaTitle: "Chat in Beta",
    betaBody: "Ja, ein paar Sachen kann er, der Rest ist totaler Mist.\n\nIch kriege es nicht richtig zum Laufen, nicht für all die netten Funktionen, die ich haben will, vor allem auf schwächeren Geräten. Ich wollte nur nicht, dass es den Release der App aufhält, weil der Rest fertig ist, zumindest in meinen Tests. Wenn was richtig schlecht ist, schreib ein Feedback im Play Store und ich schau, was ich machen kann!",
    betaOk: "Ok!",
  ...
  settings: {
    ...
    typewriterDesc: "Tippt Transkriptionen, sobald sie eintreffen",
    typewriterSpeed: "Schreibtempo",
    speedSlow: "Langsam",
    ...
    uiScale: "Größe der Oberfläche",
    uiScaleCompact: "Kompakt",
    uiScaleNormal: "Normal",
    uiScaleComfy: "Bequem",
    uiScaleTitle: "Größe ändern?",
    uiScaleMessage: "Die App lädt kurz neu, um die neue Größe anzuwenden.",
    uiScaleApply: "Anwenden",
    ...
    supportMessage: "Muffin ist kostenlos, privat und läuft offline. Wenn es dir gefällt und du mein Projekt unterstützen willst, hier ist wie!",
  ...
  models: {
    tierFastest: "Am schnellsten",
    tierFast: "Schnell",
    tierBalanced: "Ausgewogen",
    tierBest: "Beste Qualität",
    ...
    descFmtBest: "Sauberste Formulierung. Am langsamsten.",
    descChatFast: "Schnelle, einfachere Antworten.",
    descChatBest: "Klügere Antworten. Braucht ein neueres Handy.",
    descEmbed: "Ermöglicht dem Chat, die richtige Transkription nach Bedeutung zu finden, nicht nur nach Wörtern.",
