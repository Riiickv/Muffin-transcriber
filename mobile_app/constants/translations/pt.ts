...
export const PT = {
  ...
  models: {
    ...
    estimatePerRecording: "cerca de {t} por gravação",
    estimatePerMinute: "cerca de {t} por minuto de gravação",
    measuredPerRecording: "{t} por gravação no teu telefone",
    measuredPerMinute: "{t} por minuto de gravação no teu telefone",
