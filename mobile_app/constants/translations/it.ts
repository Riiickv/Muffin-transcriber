...
export const IT = {
  ...
  record: {
    silentTitle: "Muffin non sente nulla",
    silentBody: "Finora questa registrazione è silenziosa. Controlla che sia selezionato il microfono giusto e che nessun’altra app lo stia usando. La registrazione continua.",
  ...
  settings: {
    speedReport: "Report velocità",
    copyReport: "Copia",
    clearReport: "Cancella",
    ...
    typewriterDesc: "Scrive le trascrizioni man mano che arrivano",
    typewriterSpeed: "Velocità di scrittura",
    speedSlow: "Lenta",
  ...
  models: {
    ...
    estimatePerRecording: "circa {t} per registrazione",
    estimatePerMinute: "circa {t} al minuto di registrazione",
    measuredPerRecording: "{t} per registrazione sul tuo telefono",
    measuredPerMinute: "{t} al minuto di registrazione sul tuo telefono",
