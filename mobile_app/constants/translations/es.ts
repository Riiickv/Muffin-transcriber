...
export const ES = {
  tester: {
    welcomeTitle: "¡Eres un tester!",
    welcomeBody: "Muffin todavía está en desarrollo ¡y tú eres un tester! Si te resulta útil, dime qué te parece, sobre todo qué cambiarías, añadirías o arreglarías. ¡Gracias!",
    welcomeOk: "Entendido",
  },
  ...
  transcribe: {
    ...
    formatToggle: "Mejorar",
    summarizeToggle: "Resumir",
    formatterModelLabel: "Calidad de la mejora",
    formatLanguageLabel: "Idioma de la mejora",
  ...
  coach: {
    micHint: "¡Toca para grabar/parar, mantén pulsado para opciones!",
  },
  ...
  record: {
    ...
    formatToggle: "Mejorar transcripción",
    summarizeToggle: "Resumir",
  ...
  historyDetail: {
    ...
    retranscribe: "Retranscribir", format: "Mejorar", summarize: "Resumir",

    retranscribing: "Retranscribiendo...",
    formatting: "Mejorando...",
    summarizing: "Resumiendo...",
    working: "Trabajando...",
    summaryTooShort: "Demasiado corto para resumirlo.",
    summaryFailed: "No he podido resumirlo.",
    busyTitle: "¡Una a la vez!",
    busyMessage: "Si empiezas {next}, se detendrá {current}.",
    busyDontAsk: "No mostrar de nuevo",
    busyConfirm: "¡Ok!",
    stop: "Detener",
    stopping: "Deteniendo...",
  ...
  chat: {
    betaEnableBody: "El Chat con Muffin todavía no está listo. Puedes probarlo y enviarme feedback, eso aceleraría muchísimo su desarrollo.\n\nLo que funciona ahora:\n• Puede cambiar los ajustes de la app por ti, y señalarte dónde están.\n• Conoce toda la app, así que puede ayudarte a encontrar lo que necesites.\n• A veces encuentra la transcripción que buscas si le dices el tema.\n\nLo que no:\n• No puedes chatear con él de forma fiable, así que no puede ayudarte de verdad a darle vueltas a tus transcripciones. Es una limitación de los dispositivos móviles, y estoy buscando todas las formas posibles de aligerar la carga en teléfonos medios y menos potentes.\n\nHay muchas más funciones planeadas, pero necesitan tiempo y pruebas.\n\n¡Gracias por la paciencia!\n\n-Rick",
    header: "Chat",
    beta: "Beta",
  ...
  settings: {
    ...
    typewriterDesc: "Escribe las transcripciones a medida que llegan",
    typewriterSpeed: "Velocidad de escritura",
    speedSlow: "Lenta",
    speedBalanced: "Equilibrada",
    speedFast: "Rápida",
    formatByDefault: "Mejorar por defecto",
    formatByDefaultDesc: "Mejora la transcripción después de transcribirla",
    ...
    uiScaleComfy: "Cómoda",
    uiScaleTitle: "¿Cambiar el tamaño?",
    uiScaleMessage: "La app se recarga un momento para aplicar el nuevo tamaño.",
    ...
    formatSystemPrompt: "Prompt por defecto de mejora",
    ...
    formatSummarize: "Mejorar y resumir",
    preferredFormatter: "Modelo formateador",
    preferredChat: "Modelo de chat",
    formatLanguage: "Idioma de la mejora",
  ...
  models: {
    tierFastest: "Más rápido",
    tierFast: "Rápido",
    tierBalanced: "Equilibrado",
    tierBest: "Mejor calidad",
    tierAccurate: "Más preciso",
    tierSmartSearch: "Búsqueda inteligente",

    descWhisperFastest: "Redacción más tosca. Bien para notas cortas y claras.",
    descWhisperBalanced: "El punto justo para la mayoría de las notas de voz.",
    descWhisperAccurate: "El mejor con acentos y ruido de fondo. El más lento.",
    descFmtFastest: "Optimizado para los chips de teléfonos más nuevos.",
    descFmtFast: "Redacción algo mejor que Más rápido.",
    descFmtBalanced: "Más grande, pero aún ágil en teléfonos nuevos.",
    descFmtBest: "Redacción más limpia. El más lento.",
    descChatFast: "Respuestas rápidas y más simples.",
    descChatBest: "Respuestas más inteligentes. Necesita un teléfono nuevo.",
    descEmbed: "Permite que el Chat encuentre la transcripción correcta por significado, no solo por palabras.",
  ...
  dialog: {
    ...
    formattingFailed: { title: "Mejora fallida" },
