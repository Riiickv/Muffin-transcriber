...
export const ES = {
  ...
  transcribe: {
    ...
    welcomeBody: "Muffin convierte los mensajes de voz en texto. Todo ocurre en tu teléfono y no se sube nada.",
    welcomeStep: "Para empezar, descarga un modelo. Es lo que hace el trabajo. Tarda unos minutos y solo se hace una vez.",
    ...
    supportMe: "¡Apóyame!",
    supportDesc: "Muffin es gratis y funciona sin conexión. Si te gusta y quieres apoyar mi proyecto, ¡aquí tienes cómo!",
  ...
  settings: {
    ...
    supportTitle: "¡Invítame a un café! ☕",
    supportMessage: "Muffin es gratis y funciona sin conexión. Si te gusta y quieres apoyar mi proyecto, ¡aquí tienes cómo!",
